// const api_url ='https://codeforces.com/api/user.info?handles=DmitriyH;Fefer_Ivan'
...
// const getData() {
//     return fetch("https://codeforces.com/api/user.info?handles=DmitriyH;Fefer_Ivan")
//     .then(res => {
//         return res.json()
//     })
//     .then(data => {
